...
export default function AIPage() {
  ...
  const tabs = [
    ...
    { id: 'AUDIT', label: 'Espace Audit', icon: <Activity size={16} /> },
  ];
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] space-y-12">
        <header className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm font-medium text-slate-500 max-w-2xl">Pilotage centralisé des agents autonomes et des analyses prédictives.</p>
          </div>
            ...
            <div className="xl:col-span-8 space-y-10">
              ...
              <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <div className="group rounded-[2.5rem] border border-slate-200 bg-white p-10 shadow-sm hover:border-violet-500/30 transition-all hover:shadow-xl hover:shadow-violet-600/5">
                  ...
                  <p className="mt-4 text-sm text-slate-500 font-medium leading-relaxed">Configurez des assistants spécialisés pour l'audit, le juridique ou le support technique.</p>
