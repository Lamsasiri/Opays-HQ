    ...
    <div>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ color: 'var(--muted-foreground)', fontSize: '0.875rem', marginTop: '0.25rem' }}>
          Fiches employés et equity — CEO, COO, Admin uniquement
        </p>
      </div>
      <div className="card" style={{ textAlign: 'center', padding: '3rem 0' }}>
        <Users size={32} style={{ margin: '0 auto 0.75rem', opacity: 0.3, color: 'var(--muted-foreground)' }} />
        <p style={{ color: 'var(--muted-foreground)', fontSize: '0.875rem' }}>
          Module RH — à venir (Phase 3)
        </p>
      </div>
    </div>
  );
